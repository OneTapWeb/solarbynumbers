...
date: 2026-06-10
summary: "Five days after we found the wrong unit had been fitted, the installer came back and swapped the 6 kW EC 6.0 SP for the EC 8.0 SP we actually ordered. The race against export certification is won."
...
to it has to be re-established, and the DHCP reservation re-pointed. None of that's hard. It's
